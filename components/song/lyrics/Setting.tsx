...
import { TempoType } from '@prisma/client';
...
const Setting = ({ initialData, onSetSetting }: any) => {
    ...
    <div className="my-8">
      <Card>
        <CardHeader onClick={handleOpen} className="cursor-pointer">
          ...
          <CardAction className="hover:bg-accent">{show ? <ChevronUp className="h-4 w-4 text-muted-foreground" /> : <ChevronDown className="h-4 w-4 text-muted-foreground" />}</CardAction>
        </CardHeader>
        {show && (
          <CardContent>
            ...
            <FieldSet>
              <div className="flex h-full items-center gap-3">
                ...
                />
                <FieldLegend className="mb-0">Chords</FieldLegend>
              </div>
              {setting.isChords && (
                <div className="w-full">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
                    ...
                    <Field>
                      ...
                      <Input name="bpm" placeholder="120" value={setting.bpm} onChange={handleChange} />
                    </Field>
                    {/* TIME */}
                    <Field>
                      <FieldLabel>Time</FieldLabel>
                      <Input name="time" placeholder="4/4" value={setting.time} onChange={handleChange} />
                    </Field>
                    {/* TEMPO */}
                    <Field>
