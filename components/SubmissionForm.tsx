      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="ARTIST_REQUEST">Artist Suggestion</SelectItem>

                <SelectItem value="EVENT_REQUEST">Event Submission</SelectItem>
          ...
          <div className="space-y-2">
            ...
            <Textarea name="message" value={formData.message} onChange={handleChange} rows={6} placeholder="Describe your request..." />
          </div>
